...
import static com.procurement.orchestrator.domain.commands.AccessCommandType.CHECK_RESPONSES;

@Component
public class AccessCheckResponses implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(AccessCheckResponses.class);
