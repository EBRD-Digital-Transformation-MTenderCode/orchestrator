...
public class AccessCreatePin implements JavaDelegate {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AccessCreatePin.class);
    ...
    public AccessCreatePin(final AccessRestClient accessRestClient,
