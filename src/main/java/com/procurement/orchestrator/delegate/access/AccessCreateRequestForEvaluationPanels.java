...
import static com.procurement.orchestrator.domain.commands.AccessCommandType.CREATE_REQUESTS_FOR_EV_PANELS;

@Component
public class AccessCreateRequestForEvaluationPanels implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(AccessCreateRequestForEvaluationPanels.class);
    ...
    public AccessCreateRequestForEvaluationPanels(
