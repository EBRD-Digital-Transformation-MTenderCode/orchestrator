...
import static com.procurement.orchestrator.domain.commands.AccessCommandType.GET_LOT;

@Component
public class AccessGetLot implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(AccessGetLot.class);
    ...
    public void execute(final DelegateExecution execution) throws Exception {
        ...
        final JsonNode commandMessage = processService.getCommandMessage(GET_LOT, context, jsonUtil.empty());
        ...
        if (responseData != null) {
            ...
            final JsonNode step = addLot(jsonData, responseData, processId);
            if (LOG.isDebugEnabled())
