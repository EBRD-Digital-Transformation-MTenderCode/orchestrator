...
public class ClarificationCalculateAndSavePeriod implements JavaDelegate {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ClarificationCalculateAndSavePeriod.class);
    ...
    public ClarificationCalculateAndSavePeriod(final ClarificationRestClient clarificationRestClient,
