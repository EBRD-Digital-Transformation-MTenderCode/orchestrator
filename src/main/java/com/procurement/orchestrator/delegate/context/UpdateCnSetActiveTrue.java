...
@Component
public class UpdateCnSetActiveTrue implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(UpdateCnSetActiveTrue.class);
    ...
    public UpdateCnSetActiveTrue(final RequestService requestService,
