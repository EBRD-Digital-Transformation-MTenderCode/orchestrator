...
@Component
public class ContractingCheckCanByLot implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(ContractingCheckCanByLot.class);
    ...
    public ContractingCheckCanByLot(final ContractingRestClient contractingRestClient,
