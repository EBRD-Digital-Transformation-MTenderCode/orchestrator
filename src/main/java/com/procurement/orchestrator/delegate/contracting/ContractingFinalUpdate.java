...
@Component
public class ContractingFinalUpdate implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(ContractingFinalUpdate.class);
    ...
    public ContractingFinalUpdate(final ContractingRestClient contractingRestClient,
