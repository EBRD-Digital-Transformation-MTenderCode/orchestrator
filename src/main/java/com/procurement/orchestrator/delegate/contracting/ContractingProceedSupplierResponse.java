...
@Component
public class ContractingProceedSupplierResponse implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(ContractingProceedSupplierResponse.class);
    ...
    public ContractingProceedSupplierResponse(final ContractingRestClient contractingRestClient,
