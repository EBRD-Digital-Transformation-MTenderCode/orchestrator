...
@Component
public class ContractingVerification implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(ContractingVerification.class);
    ...
    public ContractingVerification(final ContractingRestClient contractingRestClient,
