...
import static com.procurement.orchestrator.domain.commands.EvaluationCommandType.PREPARE_CANCELLATION;

@Component
public class EvaluationPrepareCancellation implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(EvaluationPrepareCancellation.class);
    ...
    public EvaluationPrepareCancellation(final EvaluationRestClient evaluationRestClient,
