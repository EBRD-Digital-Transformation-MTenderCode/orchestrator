...
import static com.procurement.orchestrator.domain.commands.MdmCommandType.ENRICH_DATA_FOR_UPDATE_AP;

@Component
public class MdmEnrichDataForUpdateAP implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(MdmEnrichDataForUpdateAP.class);
    ...
    public MdmEnrichDataForUpdateAP(final MdmRestClient mdmRestClient,
    ...
    public void execute(final DelegateExecution execution) throws Exception {
        ...
        if (prevData != null) {
            ...
            final JsonNode commandMessage = processService.getCommandMessage(ENRICH_DATA_FOR_UPDATE_AP, context, requestNode);
