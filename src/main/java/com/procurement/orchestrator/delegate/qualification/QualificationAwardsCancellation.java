...
public class QualificationAwardsCancellation implements JavaDelegate {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(QualificationAwardsCancellation.class);
    ...
    public QualificationAwardsCancellation(final QualificationRestClient qualificationRestClient,
