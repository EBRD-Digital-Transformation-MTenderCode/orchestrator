...
import static com.procurement.orchestrator.domain.commands.RequisitionCommandType.CHECK_LOT_AWARDED;

@Component
public class RequisitionCheckLotAwarded implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(RequisitionCheckLotAwarded.class);
    ...
    public RequisitionCheckLotAwarded(final RequisitionRestClient requisitionRestClient,
