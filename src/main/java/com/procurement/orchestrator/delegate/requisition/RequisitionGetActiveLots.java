...
import static com.procurement.orchestrator.domain.commands.RequisitionCommandType.GET_ACTIVE_LOTS;

@Component
public class RequisitionGetActiveLots implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(RequisitionGetActiveLots.class);
    ...
    public RequisitionGetActiveLots(final RequisitionRestClient requisitionClient,
