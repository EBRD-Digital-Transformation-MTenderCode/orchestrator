...
import static com.procurement.orchestrator.domain.commands.RequisitionCommandType.GET_AWARD_CRITERIA_AND_CONVERSATIONS;

@Component
public class RequisitionGetAwardCriteriaAndConversions implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(RequisitionGetAwardCriteriaAndConversions.class);
    ...
    public RequisitionGetAwardCriteriaAndConversions(
