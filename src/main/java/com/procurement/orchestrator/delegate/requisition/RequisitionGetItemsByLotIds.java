...
import static com.procurement.orchestrator.domain.commands.RequisitionCommandType.GET_ITEMS_BY_LOT_IDS;


@Component
public class RequisitionGetItemsByLotIds implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(RequisitionGetItemsByLotIds.class);
    ...
    public RequisitionGetItemsByLotIds(final RequisitionRestClient requisitionClient,
    ...
    public void execute(final DelegateExecution execution) throws Exception {
        ...
        final JsonNode commandMessage = processService.getCommandMessage(GET_ITEMS_BY_LOT_IDS, context, payload);
    ...
    private JsonNode addItems(final JsonNode jsonData, final JsonNode responseNode, final String processId) {
        try {
            ((ObjectNode) jsonData).set("items", responseNode.get("items"));
            return jsonData;
        } catch (Exception e) {
