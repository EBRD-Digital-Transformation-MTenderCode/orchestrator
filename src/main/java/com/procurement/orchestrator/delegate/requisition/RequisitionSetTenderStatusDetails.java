...
import static com.procurement.orchestrator.domain.commands.RequisitionCommandType.SET_TENDER_STATUS_DETAILS;

@Component
public class RequisitionSetTenderStatusDetails implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(RequisitionSetTenderStatusDetails.class);
    ...
    public RequisitionSetTenderStatusDetails(final RequisitionRestClient requisitionRestClient,
