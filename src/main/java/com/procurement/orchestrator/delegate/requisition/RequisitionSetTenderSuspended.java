...
import static com.procurement.orchestrator.domain.commands.RequisitionCommandType.SET_TENDER_SUSPENDED;

@Component
public class RequisitionSetTenderSuspended implements JavaDelegate {
