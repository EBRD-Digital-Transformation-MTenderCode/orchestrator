...
import static com.procurement.orchestrator.domain.commands.RequisitionCommandType.SET_TENDER_UNSUCCESSFUL;

@Component
public class RequisitionSetTenderUnsuccessful implements JavaDelegate {
    private static final Logger LOG = LoggerFactory.getLogger(RequisitionSetTenderUnsuccessful.class);
    ...
    public RequisitionSetTenderUnsuccessful(final RequisitionRestClient requisitionRestClient,
