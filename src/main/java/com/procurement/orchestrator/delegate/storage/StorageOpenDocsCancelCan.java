...
@Component
public class StorageOpenDocsCancelCan implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(StorageOpenDocsCancelCan.class);
    ...
    public StorageOpenDocsCancelCan(final StorageRestClient storageRestClient,
