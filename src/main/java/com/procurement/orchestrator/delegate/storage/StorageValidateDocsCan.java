...
@Component
public class StorageValidateDocsCan implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(StorageValidateDocsCan.class);
    ...
    public StorageValidateDocsCan(final StorageRestClient storageRestClient,
