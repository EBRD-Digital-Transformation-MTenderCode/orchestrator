...
@Component
public class StorageValidateDocsCancelCan implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(StorageValidateDocsCancelCan.class);
    ...
    public StorageValidateDocsCancelCan(final StorageRestClient storageRestClient,
