...
@Component
public class StorageValidateDocsOfAward implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(StorageValidateDocsOfAward.class);
    ...
    public StorageValidateDocsOfAward(final StorageRestClient storageRestClient,
