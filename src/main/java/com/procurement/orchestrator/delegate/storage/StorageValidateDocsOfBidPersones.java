...
@Component
public class StorageValidateDocsOfBidPersones implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(StorageValidateDocsOfBidPersones.class);
    ...
    public StorageValidateDocsOfBidPersones(
