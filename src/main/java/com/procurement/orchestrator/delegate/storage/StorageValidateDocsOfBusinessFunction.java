...
@Component
public class StorageValidateDocsOfBusinessFunction implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(StorageValidateDocsOfBusinessFunction.class);
    ...
    public StorageValidateDocsOfBusinessFunction(
