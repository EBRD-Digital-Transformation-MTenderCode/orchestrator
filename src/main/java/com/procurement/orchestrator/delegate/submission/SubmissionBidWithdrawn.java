...
public class SubmissionBidWithdrawn implements JavaDelegate {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SubmissionBidWithdrawn.class);
    ...
    public SubmissionBidWithdrawn(final SubmissionRestClient submissionRestClient,
