...
@Component
public class NoticePost implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(NoticePost.class);
    ...
    public NoticePost(final NoticeRestClient noticeRestClient,
