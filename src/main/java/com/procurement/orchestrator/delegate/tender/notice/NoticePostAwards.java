...
@Component
public class NoticePostAwards implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(NoticePostAwards.class);
    ...
    public NoticePostAwards(final NoticeRestClient noticeRestClient,
