...
class RequestId private constructor(private val value: String) : Serializable {
    ...
    companion object {
        ...
        fun tryCreateOrNull(text: String): RequestId? = if (validation(text)) RequestId(text) else null
