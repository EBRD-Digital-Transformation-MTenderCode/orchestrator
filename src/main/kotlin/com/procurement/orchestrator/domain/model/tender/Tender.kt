...
import com.procurement.orchestrator.domain.model.tender.criteria.Criterias
...
data class Tender(
    ...
    @field:JsonProperty("criteria") @param:JsonProperty("criteria") val criteria: Criterias = Criterias(),
