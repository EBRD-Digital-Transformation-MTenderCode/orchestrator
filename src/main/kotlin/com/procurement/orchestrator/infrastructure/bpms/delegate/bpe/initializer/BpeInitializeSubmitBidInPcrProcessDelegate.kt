...
@Component
class BpeInitializeSubmitBidInPcrProcessDelegate(
    val logger: Logger,
    transform: Transform,
    ...
    override fun updateGlobalContext(
        ...
        val payload: SubmitBidInPcr.Request.Payload =
            parsePayload(camundaContext.request.payload, SubmitBidInPcr.Request.Payload::class.java)
    ...
    private fun buildBids(
        bidId: BidId,
        payload: SubmitBidInPcr.Request.Payload
    ): Bids = payload.bid
        .let { bid ->
            Bid(
                id = bidId,
