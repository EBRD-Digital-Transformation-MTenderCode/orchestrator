...
@Component
class ChronographScheduleEndTenderPeriodAuctionInPcrDelegate(
    ...
    companion object {
        private const val PROCESS_TYPE_TENDER_PERIOD_END_AUCTION_PCR = "tenderPeriodEndAuctionInPcr"
    ...
    override suspend fun execute(
        ...
        val contextChronograph = Context.Builder()
            ...
            .setProcessType(PROCESS_TYPE_TENDER_PERIOD_END_AUCTION_PCR)
