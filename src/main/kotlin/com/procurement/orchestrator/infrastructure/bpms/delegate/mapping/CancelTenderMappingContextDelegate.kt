...
@Component
class CancelTenderMappingContextDelegate : DelegateVariableMapping {
    ...
    override fun mapOutputVariables(superExecution: DelegateExecution, subInstance: VariableScope) {
        ...
        val updatedTender = tender.copy(status = subTender.status, statusDetails = subTender.statusDetails)
