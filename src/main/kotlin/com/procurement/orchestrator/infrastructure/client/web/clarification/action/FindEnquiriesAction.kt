...
abstract class FindEnquiriesAction : FunctionalAction<FindEnquiriesAction.Params, FindEnquiriesAction.Result> {

    override val version: Version = Version.parse("2.0.0")
    override val name: String = "findEnquiries"
...
fun FindEnquiriesAction.Result.Enquiry.convertToGlobalContextEntity(): Enquiry =
    Enquiry(
        id           = this.id,
        title        = this.title,
        ...
        relatedItem  = null,
        author       = this.author.convertToGlobalContextEntity()
    )

private fun FindEnquiriesAction.Result.Enquiry.Author.convertToGlobalContextEntity(): OrganizationReference =
