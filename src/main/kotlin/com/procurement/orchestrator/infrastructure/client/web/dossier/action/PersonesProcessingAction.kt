...
abstract class PersonesProcessingAction : FunctionalAction<PersonesProcessingAction.Params, PersonesProcessingAction.Result> {
    ...
    class Params(
        ...
        @param:JsonProperty("role") @field:JsonProperty("role") val role: PartyRole,
