...
abstract class GetNextsForQualificationAction : FunctionalAction<GetNextsForQualificationAction.Params, GetNextsForQualificationAction.Result> {
    override val version: Version = Version.parse("2.0.0")
    override val name: String = "getNextsForQualification"
    ...
    class Params(
        ...
        data class Qualification(
            ...
            @JsonInclude(JsonInclude.Include.NON_NULL)
            @field:JsonProperty("relatedSubmission") @param:JsonProperty("relatedSubmission") val relatedSubmission: SubmissionId.Permanent?,
            @JsonInclude(JsonInclude.Include.NON_NULL)
