...
@RestController
class ApplyConfirmationsController(
    private val logger: Logger,
    private val processLauncher: ProcessLauncher
) {

    companion object {
        private const val PROCESS_NAME = "applyConfirmations"
    }

    @PostMapping("/apply/confirmations/{entity}/{cpid}/{ocid}/{entityId}")
    fun applyConfirmations(
