...
@RestController
class WithdrawPcrProtocolController(
    private val logger: Logger,
    private val processLauncher: ProcessLauncher
) {

    companion object {
        private const val PROCESS_NAME = "withdrawPcrProtocol"
    }

    @PostMapping("/cancel/protocol/pcr/{cpid}/{ocid}/{lotId}")
    fun withdrawPcrProtocol(
